...
const LoginCard = () => {
  return (
    <div className="w-[500px] rounded-2xl absolute top-[20vh] left-[10vw] p-0 border-gray-400 border-[1px] ">
      <div className="bg-[#1e78ff3e] text-[48px] font-medium text-center rounded-t-2xl font-[Roboto] ">
        Login
      </div>
      <div>
